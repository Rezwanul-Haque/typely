use crate::application::dto::{ImportSnippetsRequest, ImportResult};
use crate::domain::{Snippet, SnippetRepository};
use anyhow::Result;
use std::sync::Arc;

pub struct ImportSnippetsUseCase {
    repository: Arc<dyn SnippetRepository>,
}

impl ImportSnippetsUseCase {
    ...
    async fn import_single_snippet(
        &self,
        snippet_data: &crate::application::dto::ImportSnippetData,
    ...
    pub async fn import_from_json(&self, json_data: &str, overwrite_existing: bool) -> Result<ImportResult> {
        let import_data: Vec<crate::application::dto::ImportSnippetData> = 
...
mod tests {
    use super::*;
    use crate::application::dto::ImportSnippetData;
    ...
    async fn create_test_use_case() -> (ImportSnippetsUseCase, CreateSnippetUseCase, TempDir) {
        ...
        let import_use_case = ImportSnippetsUseCase::new(repository.clone());
